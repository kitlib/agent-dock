...
- Frontend details: `src/AGENTS.md`
- Backend details: `src-tauri/AGENTS.md`
...
- Root `AGENTS.md` should stay concise and high-level.
- Module-specific interfaces, files, and workflows belong in module-level `AGENTS.md` files.
- If a module evolves significantly, update the relevant local `AGENTS.md` instead of overloading this root file.
