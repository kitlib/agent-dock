...
- 距离“完整 Skill 管理系统”仍缺少真实 Marketplace、关系视图与统一资源模型
...
- 不再规划 `Resources` 独立页
- 当前全局资源浏览统一收敛在 `Home / Agents` 内的“全部”视图
- 下一步优先推进 `Marketplace` 真接入
